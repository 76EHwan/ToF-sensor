...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(IR_R_GPIO_Port, IR_R_Pin);

    HAL_GPIO_DeInit(GPIOA, IR_0_Pin|IR_1_Pin|IR_2_Pin|IR_3_Pin
                          |IR_4_Pin|ADC_BAT_Pin);

    HAL_GPIO_DeInit(IR_L_GPIO_Port, IR_L_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB0     ------> ADC2_INP9
    */
    HAL_GPIO_DeInit(GPIOC, SOC_L_Pin|SOB_L_Pin);

    HAL_GPIO_DeInit(SOA_L_GPIO_Port, SOA_L_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    HAL_GPIO_DeInit(SOC_R_GPIO_Port, SOC_R_Pin);
