...
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef* lptimHandle)
{
  ...
  /* USER CODE END LPTIM1_MspDeInit 0 */
    ...
    PE1     ------> LPTIM1_IN2
    */
    HAL_GPIO_DeInit(ENC_R_IN1_GPIO_Port, ENC_R_IN1_Pin);

    HAL_GPIO_DeInit(ENC_R_IN2_GPIO_Port, ENC_R_IN2_Pin);
  ...
  /* USER CODE END LPTIM2_MspDeInit 0 */
    ...
    PD11     ------> LPTIM2_IN2
    */
    HAL_GPIO_DeInit(ENC_L_IN1_GPIO_Port, ENC_L_IN1_Pin);

    HAL_GPIO_DeInit(ENC_L_IN2_GPIO_Port, ENC_L_IN2_Pin);
